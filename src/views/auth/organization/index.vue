  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button round size="small" class="filter-item fr"
                 ...
                 v-permission="['SYS_ORGANIZATION_INSERT']" @click="handleAdd">
        添加
      </el-button>
    </div>
    <el-table
      ...
      <el-table-column label="操作" align="center" width="140" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-button size="mini" type="primary"
                     v-permission="['SYS_ORGANIZATION_UPDATE']" @click="handleUpdate(row)">
            修改
          </el-button>
          <el-button size="mini" type="danger"
                     v-permission="['SYS_ORGANIZATION_DELETE']" @click="handleDelete(row)">
            删除
          </el-button>
        </template>
      </el-table-column>
